...
- Platform: `kmod-hwmon-pwmfan`, `cm5-button-scripts` (USERKEY/MaskROM; chains to mcudd via `hotplug-call button`), USB Wi-Fi (`kmod-mt76x2u`, `kmod-rtl8812au-ct`), `i2c-tools`, `gpiod-tools`
