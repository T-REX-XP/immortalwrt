...
- UI: `luci-ssl`, `luci-mod-*`, `luci-app-peripherals`, `luci-app-oled`, `luci-app-mcu-display`, `luci-app-blocky`, `luci-app-commands`
...
Custom feed packages (`blocky`, `luci-app-blocky`, `luci-app-oled`, `luci-app-mcu-display`, `luci-app-peripherals`, `cm5-button-scripts`) require `openwrt_packages` feed at build time.
